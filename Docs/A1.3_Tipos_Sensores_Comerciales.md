...
1. Utilice el siguiente listado de modelos de sensores comerciales para elaborar su actividad:
   ...
   - [x] 1.6 Sensor de color RGB TCS34725
...
3. Una vez que conoce el tema a desarrollar, investigue y redacte dentro de este documento los puntos siguiente:
   ...
   - **Desarrollo**
    ...
    - 
 # [**Documento PDF en Drive**](https://drive.google.com/file/d/16wPdQ3AQMNzGIZa59KNUJf8NgnviqeEC/view?usp=sharing)
...
![Conversación en Slack 1](../Img/A1.3_slack_1.png)

![Conversación en Slack 2](../Img/A1.3_slack_2.png)

![Historial en Google Drive](../Img/A1.3_drive_historial.png)
___
