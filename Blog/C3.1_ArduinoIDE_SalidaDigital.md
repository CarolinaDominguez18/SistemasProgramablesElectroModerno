...
![](../Img/C3.x_ArduinoEsquematicoSalidaDigital.png)
2. Analice y escriba el programa que se muestra a continuación.

![](../Img/C3.x_ArduinoProgramaSalidaDigital.png)

3. Explique el resultado observado.
   
El programa y arduino, hace parpadear el pin 13 del Arduino. Y el nivel del voltaje hace encender el LED en 1000 milisegundos, e igual cuando se apaga.

1. Inserte aquí las imágenes que considere como evidencias para demostrar el resultado obtenido.

![](../Img/C3.1_AduinoCodigo.png)
